...
const navToggel = document.getElementById('nav-toggle');
...
function sliderPortfolio (){
    const sliders = [...document.querySelectorAll('.portfolio__content')];
    ...
    function changePosition (change) {
       ...
       sliders[currentElement-1].classList.toggle('portfolio__content--show');
       sliders[value-1].classList.toggle('portfolio__content--show');
